<?php 
	...
	print $db;
	print $this->id();
	if(isset($red->html->form['submit'])){
			$red->sql->settings($red->html->form['name'], $red->html->form['login'], $red->html->form['pass'], $red->html->form['host']);
			$this->redirect('main','page');
			}
	if(isset($red->html->form['table'])){
